...
singlepulse_maxwidth    = 5.0  # max pulse width in seconds
singlepulse_speed       = '--iter' #'--fast', '--iter' or blank
singlepulse_cluster     = '--clust' #--clust turns on cluster, otherwise blank
singlepulse_flag        = '--noflag' #Don't flag high std blocks
